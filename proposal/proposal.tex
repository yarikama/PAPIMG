...
\begin{tikzpicture}[
  ...
  stglbl/.style = {font=\tiny\bfseries},
  sublbl/.style = {font=\tiny\itshape},
]

%% --- I/O ---
\node[iobox]                      (img)   {Image\\{\tiny(RGB)}};
\node[iobox, below=1.20cm of img] (txt)   {Text Prompt};
...
%% --- Stage 2 ---
\node[box=cred,  right=1.0cm of vtok, yshift=-0.60cm] (score) {Cosine\\Scoring};
...
\begin{pgfonlayer}{background}
  ...
  \node[draw=green!35, fill=green!4, rounded corners=4pt,
        fit=(mlp)(llava)(out),
        label={[stglbl, green!60, yshift=2pt]above:%
